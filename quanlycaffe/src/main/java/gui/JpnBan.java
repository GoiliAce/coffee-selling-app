...
public class JpnBan extends javax.swing.JPanel {
    ...
    private void addControls() throws Exception {
        ...
        for (Ban b:banDao.layDanhSachBan()) {
        	dsBanCon.add(new JpnBanCon(b.getMaBan()));
        }
        ...
        btnThemBan.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				soBan+=1;
				try {
					banDao.themBan(new Ban(false));
				} catch (Exception e1) {
					e1.printStackTrace();
				}
				JpnBanCon banMoi = new JpnBanCon(soBan);
				jpnBan.add(banMoi);
				dsBanCon.add(banMoi);	
				int col = soBan/2+1;
		        jpnBan.setLayout(new GridLayout(col, 2));
	...
	private void dsBanConActionListener() {
		for (JpnBanCon x: dsBanCon) {
			...
			btnBan.addActionListener(new ActionListener() {
				...
				@Override
				public void actionPerformed(ActionEvent e) {
					tfBan.setText(btnBan.getText().replace("Bàn", ""));
				}
			});
        }
	}
    ...
    private void initComponents() {
        ...
        btnXoaBan.setBackground(new java.awt.Color(230, 219, 209));
        btnXoaBan.setFont(new java.awt.Font("Times New Roman", 0, 20)); // NOI18N
        btnXoaBan.setText("Xóa Bàn");
        btnXoaBan.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 102)));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btnXoaBan, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jpnBanScroll))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnXoaBan, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnThemBanActionPerformed(java.awt.event.ActionEvent evt) {                                           
